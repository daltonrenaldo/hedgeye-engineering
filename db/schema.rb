...
ActiveRecord::Schema.define(:version => 20120817012727) do
  ...
  create_table "refinery_perks", :force => true do |t|
    t.string   "title"
    t.text     "description"
    t.string   "teaser"
  ...
  create_table "refinery_social_networks", :force => true do |t|
    t.string   "name"
  ...
  create_table "refinery_teammates", :force => true do |t|
    t.string   "title"
    t.string   "name"
    t.string   "email"
  ...
  create_table "refinery_twitter_accounts", :force => true do |t|
    t.string   "username"
